  ...
  return (
    <div className={cn("rounded-xl bg-gray-900 p-8 shadow-xl", className)}>
      <div className="flex flex-col items-center justify-center gap-8 md:flex-row">
        <div className="shrink-0 text-center text-white md:text-right">{children}</div>
...
export function BlackCTAHeading({ children }: { children: React.ReactNode }) {
  return (
    <Heading level={1} className="mb-0 text-6xl text-white md:mb-0 md:text-8xl md:tracking-tight">
      {children}
    </Heading>
  )
}
