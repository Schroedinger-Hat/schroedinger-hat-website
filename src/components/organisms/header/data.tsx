...
export const partecipateMenuData = [
    {
      ...
      icon: <Calendar03Icon className="w-20 h-20 opacity-70"/>
    },
    {
      title: "Projects",
...
export const contributeMenuData = [
    {
      ...
      icon: <UserLove01Icon className="w-20 h-20 opacity-70"/>
    },
    {
      title: "As Speaker",
...
export const associationMenuData: { title: string; href: string; description: string }[] = [
    {
      title: "About Us",
