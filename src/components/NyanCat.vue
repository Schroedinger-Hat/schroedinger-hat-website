...
.rainbow > span {
  background-image: linear-gradient(to right, $red 0, $red 50%, transparent 50%, transparent 100%),
    ...
    linear-gradient(to right, $yellow 0, $yellow 50%, $orange 50%, $orange 100%),
    linear-gradient(to right, $yellow 0, $yellow 100%),
    linear-gradient(to right, $green 0, $green 50%, $yellow 50%, $yellow 100%),
    linear-gradient(to right, $green 0, $green 100%),
    linear-gradient(to right, $royalblue 0, $royalblue 50%, $green 50%, $green 100%),
    linear-gradient(to right, $royalblue 0, $royalblue 100%),
    linear-gradient(to right, $purple 0, $purple 50%, $royalblue 50%, $royalblue 100%),
    linear-gradient(to right, $purple 0, $purple 100%),
    linear-gradient(to right, transparent 0, transparent 50%, $purple 50%, $purple 100%),
    linear-gradient(to right, transparent 0, transparent 50%, $red 50%, $red 100%),
    linear-gradient(to right, $red 0, $red 100%),
    linear-gradient(to right, $red 0, $red 50%, $orange 50%, $orange 100%),
    linear-gradient(to right, $orange 0, $orange 100%),
    linear-gradient(to right, $orange 0, $orange 50%, $yellow 50%, $yellow 100%),
    linear-gradient(to right, $yellow 0, $yellow 100%),
    linear-gradient(to right, $yellow 0, $yellow 50%, $green 50%, $green 100%),
    linear-gradient(to right, $green 0, $green 100%),
    linear-gradient(to right, $green 0, $green 50%, $royalblue 50%, $royalblue 100%),
    linear-gradient(to right, $royalblue 0, $royalblue 100%),
    linear-gradient(to right, $royalblue 0, $royalblue 50%, $purple 50%, $purple 100%),
    linear-gradient(to right, $purple 0, $purple 100%),
    linear-gradient(to right, $purple 0, $purple 50%, transparent 50%, transparent 100%);
}
...
.tail > span {
  background-image: linear-gradient(
    ...
    linear-gradient(to right, transparent 0, transparent 100%),
    linear-gradient(to right, transparent 0, transparent 20px, black 20px),
    linear-gradient(to right, transparent 0, transparent 10px, black 10px),
    linear-gradient(to right, transparent 0, transparent 5px, black 5px, black 10px, $gray 10px),
    linear-gradient(to right, black 0, black 5px, $gray 5px, $gray 20px, black 20px),
    linear-gradient(to right, transparent 0, transparent 5px, black 5px),
    linear-gradient(to right, transparent 0, transparent 20px, black 20px),
